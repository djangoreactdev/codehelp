...
import { useLazyGetUserReposQuery, useSearchUsersQuery } from "../github.api";
import { useDebounce } from "../../../hooks/debounce";
import { GitRepoCard } from "./GitRepoCard";

export function GitSearchPage() {
    ...
    <div className="flex justify-center pt-10 mx-auto h-full w-full">
      ...
      <div className="relative w-[560px]">
        ...
        {dropdown && (
          ...
          overflow-y-scroll shadow-md bg-white"
          >
        ...
        <div className="container">
          ...
          {repos?.map((repo) => (
            <GitRepoCard repo={repo} key={repo.id} />
          ))}
        </div>
      </div>
    </div>
