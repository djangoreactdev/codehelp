...
export function NavBar(props: ClassProps) {
  ...
  return (
    <>
      <header className="sticky top-0 z-999 flex w-full mb-1 bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none rounded-md">
        <div className="flex flex-grow items-center justify-between py-3 px-4 shadow-2 md:px-6 2xl:px-11">
          <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
            ...
            >
              ...
              { '!w-full delay-300': !sidebarToggle }"
                  ></span>
                  <span
                    className="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-150 duration-200 ease-in-out dark:bg-white
              { '!w-full delay-400': !sidebarToggle }"
                  ></span>
                  <span
                    className="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-200 duration-200 ease-in-out dark:bg-white
              { '!w-full delay-500': !sidebarToggle }"
                  ></span>
                </span>
                <span className="du-block absolute right-0 h-full w-full rotate-45">
                  <span
                    className="absolute left-2.5 top-0 block h-full w-0.5 rounded-sm bg-black delay-300 duration-200 ease-in-out dark:bg-white
              { '!h-0 delay-[0]': !sidebarToggle }"
                  ></span>
                  <span
                    className="delay-400 absolute left-0 top-2.5 block h-0.5 w-full rounded-sm bg-black duration-200 ease-in-out dark:bg-white
              { '!h-0 dealy-200': !sidebarToggle }"
                  ></span>
                </span>
              </span>
            </button>
          ...
          <div className="flex items-center gap-3 2xsm:gap-7">
            <ul className="flex items-center gap-2 2xsm:gap-4">
              <li>
                <label
                  className={`relative m-0 block h-7.5 w-14 rounded-xl + ${
                ...
                >
                  <input
                    ...
                    className="flex  z-50 m-0  w-full  opacity-0"
                  />
                  <span
                    className={`${
              ...
              <li className="relative">
                <a
                  ...
                  href="/#"
                >
                  <span className="hidden absolute -top-0.5 -right-0.5 z-1 h-2 w-2 rounded-full bg-meta-1">
                ...
                <div className="hidden absolute -right-27 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80">
              ...
              <li className="relative">
                ...
                <div className="hidden absolute -right-16 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80">
                  <div className="px-4.5 py-3">
                    <h5 className="text-sm font-medium text-bodydark2">
                      Messages
                    </h5>
            ...
            <div className="relative">
              ...
              <div className="hidden absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
